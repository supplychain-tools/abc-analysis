 ...
 * what the host publishes and what the Playwright suite runs against.
 *
 ...
 * to find its own stylesheet. Next prefixes them from this one setting.
 *
 * It comes from the environment rather than being written in, because the same
 * source has to serve two mountings: the deployment at /eoq/, and the dev
 * server and Playwright suite at the root of localhost. Unset means root,
